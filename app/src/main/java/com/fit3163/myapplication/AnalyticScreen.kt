...
// Preview function - use this for preview only
//@androidx.compose.ui.tooling.preview.Preview(showBackground = true)
//@Composable
//fun AnalyticsScreenPreview() {
//    // Create a simple preview version without auth dependencies
//    AnalyticsScreenPreviewContent()
//}
//
//// Separate composable for preview content only
//@OptIn(ExperimentalMaterial3Api::class)
//@Composable
//fun AnalyticsScreenPreviewContent() {
//    Scaffold(
//        topBar = {
//            TopAppBar(
...
//        ) {
//            // Timeframe selector
//            TimeframeSelector(selectedOption = timeframe,
//                onOptionSelected = { timeframe = it })
//
